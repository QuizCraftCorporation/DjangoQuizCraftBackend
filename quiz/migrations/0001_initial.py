...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name="Material",
            fields=[
                ("name", models.CharField(max_length=60, verbose_name="material name")),
                (
                    "id",
                    models.BigAutoField(
                        primary_key=True, serialize=False, verbose_name="material id"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id",
                    models.BigAutoField(
                        primary_key=True, serialize=False, verbose_name="quiz id"
                    ),
                ),
                (
                    "source_id",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(blank=True, verbose_name="topic description"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "passage_date",
                    models.DateField(auto_now_add=True, verbose_name="passage date"),
                ),
                (
                    "quiz",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            name="QuizGroup",
            fields=[
                ("name", models.CharField(max_length=42, verbose_name="group name")),
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "position",
                    models.PositiveIntegerField(verbose_name="position offset"),
                ),
                (
                    "question",
                    models.ForeignKey(
